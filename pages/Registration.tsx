  ...
  return (
    <div className="space-y-6 pb-20 text-white">
      ...
      <Modal
          ...
          title={isEditingPairId ? 'Editar Pareja' : 'Nueva Pareja'}
          icon={<Users size={28} />}
          iconColor="brand"
          size="md"
          actions={[
              { label: 'Cancelar', onClick: closePairModal, variant: 'secondary' },
              { label: 'Guardar', onClick: handleSavePair, variant: 'primary' },
          ]}
      >
          <PlayerSelector
              label="JUGADOR 1"
      ...
      {/* SOLO MATCH MODAL */}
      <Modal
          isOpen={!!showSoloMatchModal}
          onClose={() => setShowSoloMatchModal(null)}
          title="Emparejar Jugador"
          body="Elige un compañero. Puedes buscar en el club o seleccionar a otro jugador suelto."
          size="sm"
          actions={[
              { label: 'Cancelar', onClick: () => setShowSoloMatchModal(null), variant: 'secondary' },
              { label: 'Confirmar', onClick: handleConfirmSoloMatch, variant: 'primary' },
          ]}
      >
          <PlayerSelector
              label="COMPAÑERO"
      ...
      <Modal
          ...
          iconColor="danger"
          actions={[
              { label: 'Cancelar', onClick: () => setShowDeleteModal(null), variant: 'secondary' },
              { label: 'Eliminar', onClick: deletePairHandler, variant: 'danger' },
          ]}
      >
