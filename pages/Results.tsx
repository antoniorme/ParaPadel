          ...
          <div className="space-y-6 pb-20 text-white">
              ...
              <div className="space-y-3">
               ...
               <Modal
                    ...
                    size="sm"
                    actions={[
                        { label: 'Cancelar', onClick: () => setEditMatchId(null), variant: 'secondary' },
                        { label: 'Guardar', onClick: handleSaveEdit, variant: 'primary' },
                    ]}
                >
                    <div className="flex gap-4 items-center justify-center">
                        <input type="number" value={scoreA} onChange={e => setScoreA(e.target.value)} className="w-20 bg-slate-50 border rounded-xl p-3 text-2xl text-center font-bold text-slate-900" />
                        <span className="text-2xl font-bold text-slate-300">-</span>
                        <input type="number" value={scoreB} onChange={e => setScoreB(e.target.value)} className="w-20 bg-slate-50 border rounded-xl p-3 text-2xl text-center font-bold text-slate-900" />
                    </div>
                </Modal>
          </div>
      );
